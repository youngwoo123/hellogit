...
<body>
    ...
    <div id="header">
        <ul>
            ...
            <li class="home"><a href="Main.html"><img src="image/home.png"></a></li>
        ...
        <div class="collapse">
            ...
            <div class="collapse-item">
                ...
                <div class="collapse-title"><a href="#content1"> <p id="date"> 2020.09.27</p><br>
                    <span class='high'>[공지]</span> 설렉션닷컴 개인정보처리방침 개정 안내</a></div>
                <!-- 게시글 내용영역 -->
                <div id="content1" class="content"><p><br><br>안녕하세요. 더설렉션닷컴입니다.<br>
            ...
            <div class="collapse-item">
                ...
                <!-- 게시글 내용영역 -->
                <div id="content2" class="content"><p><br><br>안녕하세요, 더설렉션닷컴 입니다.<br>
                6월 16일 새벽 03시 ~ 04시 더설렉션닷컴 서비스 점검 안내드립니다.<br><br>

                더설렉션닷컴 서비스 품질 향상을 위한 시스템 작업이 있을 예정입니다.<br>
            ...
            <div class="collapse-item">
                ...
                <div id="content3" class="content">
                    <p><br><br>안녕하세요, 더설렉션닷컴입니다.<br>

                    더한섬닷컴 5월 베스트 리뷰 TOP5 이벤트의 당첨자를 발표합니다 ♥<br><br>

                    [이벤트 정보]<br>
                    ㅇ이벤트명 : 더설렉션닷컴 5월 베스트 리뷰 TOP5 이벤트<br>
