...
<body>
        ...
        <div id="order_list_wrap">
            ...
            <div class="order_box">
                <div class="order_info truck">
                    ...
                    <div class="deliv_sub">2020.08.04. 23:38:18</div>
                    <div class="menu_vertical"><img src="image/bin.png"></div>
                </div>
                <ul class="order_item_ul">
                    <li>
                        <div class="order_item_content">
    ...
    <div id="modal">
        ...
        <div id="header">
            <ul>
                ...
                <li class="delivery_cancel close_btn"><img src="image/close2.png"></a></li>
            </ul>
        </div>
    ...
    <script type="text/javascript">
        ...
        $("#refund_info_box_inner_box .title img").click(function() {
            ...
            if (src.attr("src") == "image/plus.png") {
                src.attr("src", "image/minus.png");
            } else {
                src.attr("src", "image/plus.png");
            }
